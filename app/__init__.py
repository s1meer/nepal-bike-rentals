...
app.config['ESEWA_API_URL'] = os.getenv('ESEWA_API_URL', 'https://epay.esewa.com.np/api/epay/main/v2/form')
app.config['ESEWA_STATUS_URL'] = os.getenv('ESEWA_STATUS_URL', 'https://epay.esewa.com.np/api/epay/transaction/status/')
app.config['ESEWA_MERCHANT_CODE'] = os.getenv('ESEWA_MERCHANT_CODE', 'your-live-merchant-code')
app.config['ESEWA_SECRET_KEY'] = os.getenv('ESEWA_SECRET_KEY', 'your-live-secret-key')
